 ...
 */
METUI_FUN['head_nav_met_16_3'] = {
    name:'head_nav_met_16_3',
    init: function() {
        
        var wh=$(window).height(),
        $metnav_fixed=$(".met-head.navbar-fixed-top .head_nav_met_16_3"),
        $metnav_lang=METUI['head_nav_met_16_3'].find('.met-langlist'),
        $metnav_member=METUI['head_nav_met_16_3'].find('.navbar-toggler'),
        $met_navlist=METUI['head_nav_met_16_3'].find('.navlist');
        // 头部固定模式
        ...
        //导航过高 内容居中
        var nav_height=$('.head_nav_met_16_3').height();
        
        var content_height=$('.head_nav_met_16_3 .container .row').height();
        var result_height=(nav_height-content_height)/2;
        $('.head_nav_met_16_3 .row.nav-height').css('padding-top',result_height);
        // 处理导航过长
    ...
    cntotc:function(){
            //简体繁体互换
            var b=METUI['head_nav_met_16_3'].find('.btn-cntotc');
    ...
    appear: function() {
        if (METUI['head_nav_met_16_3'].length) {
            var repeat = false;
           function animation() {
                if (repeat == false) {
                    var fixed = METUI['head_nav_met_16_3'].find('.header-fixed'),
                    ...
                    headAnimate.add(a);
                    var li = METUI['head_nav_met_16_3'].find('.navlist>li');
            ...
            var scene = new ScrollMagic.Scene({
                triggerElement: '.head_nav_met_16_3',
                offset: -300
            }).addTo(controller);
    ...
    nav:function (){
        // 头部标语
        var $metcolumn_nav=METUI['head_nav_met_16_3'].find('.head-list');
        if($metcolumn_nav.length){
            $metcolumn_nav.navtabSwiper();
        }
    }
};
var x = new metui(METUI_FUN['head_nav_met_16_3']);
                    ...
                    if (slide.length > 1) {
                        METUI['banner_met_11_4'].slick({
                            ...
                            speed: speed
                             ...
                             METUI['banner_met_11_4'].find('.cover-image').css('display', 'block');
...
METUI_FUN['foot_info_met_16_2'] = {
    ...
    cntotc:function(){
            //简体繁体互换
            var b=METUI['foot_info_met_16_2'].find('.btn-cntotc');
        b.on('click', function(event) {
             var lang=$(this).attr('data-tolang');
...
METUI_FUN['about_list_met_21_3'] = {
    name:'about_list_met_21_3',
    appear:function (){
        // 首页首屏内动画预加载
        var indexappear=$('.met-index-body:eq(0) [data-plugin=appear]');
        if(indexappear.length){
...
var x = new metui(METUI_FUN['about_list_met_21_3']);
 ...
 * device_type       客户端判断（d：PC端，t：平板端，m：手机端）
 */
METUI_FUN['team_list_met_16_2'] = {
    name:'team_list_met_16_2',
    slick:function(){
        var a=METUI['team_list_met_16_2'].find('.user-slick');
        a.slick({
         prevArrow: '<button type="button" class="slick-prev"><i class="icon pe-angle-left"></button>',
         nextArrow: '<button type="button" class="slick-next"><i class="icon pe-angle-right"></button>',
         dots: false,
         autoplay:true,
         autoplaySpeed:4000,
         slidesToShow: 4,
...
var x = new metui(METUI_FUN['team_list_met_16_2']);
